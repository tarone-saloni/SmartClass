"""
tools.py — Claude tool definitions for the agentic workflow.
...
SMARTCLASS_TOOLS = [
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "content": {"type": "string", "description": "Optional source content to base questions on"},
    ...
    },
    {
        ...
        "description": "Explain a concept clearly with definitions, examples, and step-by-step breakdown.",
        "input_schema": {
            "type": "object",
            "properties": {
                "concept": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Create a personalized weekly study schedule based on enrolled courses and performance.",
        "input_schema": {
            "type": "object",
            "properties": {
